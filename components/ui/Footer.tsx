...
// 🎯 FIXED: Removed missing brand icons from the lucide-react import list
...
// 🎯 FIXED: Replaced icon components with clean inline SVG render methods
const socialLinks = [
  {
    href: '#',
    icon: (props: any) => (
  ...
  {
    href: 'mailto:support@startedge.com',
    icon: (props: any) => <Mail {...props} />, // Native lucide icon still works fine
  },
]
